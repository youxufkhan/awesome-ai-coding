...
| 🟡 **[dev-cookbook](https://github.com/Malloy-yang/Dev-cookbook)** <br> [![Stars](https://img.shields.io/github/stars/Malloy-yang/Dev-cookbook?style=flat-square&label=%E2%98%85)](https://github.com/Malloy-yang/Dev-cookbook) | Malloy Yang | Requirement-aligned development workflow: role-aware pipeline, dual-mode Spec, PM confirmation gate. Zero external dependencies. | Claude Code / Cursor / Trae / Generic Agents |
...
| 🟡 **[Agent QA](https://github.com/vostride/agent-qa)** <br> [![Stars](https://img.shields.io/github/stars/vostride/agent-qa?style=flat-square&label=%E2%98%85)](https://github.com/vostride/agent-qa) | Vostride | Self-improving QA agent for natural-language web and mobile tests. | 33 MCP tools for test authoring, execution, evidence triage, and debug/fix workflows. |
