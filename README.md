...
| 🟢 **[GPT-Engineer](https://github.com/gpt-engineer-org/gpt-engineer)** <br> [![Stars](https://img.shields.io/github/stars/gpt-engineer-org/gpt-engineer?style=flat-square&label=%E2%98%85)](https://github.com/gpt-engineer-org/gpt-engineer) | GPT-Engineer Org | Full codebase generator from prompts. | Generates complete frameworks, interactive query staging. |
...
| 🔴 **[oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent)** <br> [![Stars](https://img.shields.io/github/stars/code-yeongyu/oh-my-openagent?style=flat-square&label=%E2%98%85)](https://github.com/code-yeongyu/oh-my-openagent) | code-yeongyu | A plugin and agent harness for OpenCode that orchestrates multiple models into specialized agents. | CLI coding agent harness, plugin integrations. |
...
| 🟡 **[Open Agent (AFK-surf)](https://github.com/AFK-surf/open-agent)** <br> [![Stars](https://img.shields.io/github/stars/AFK-surf/open-agent?style=flat-square&label=%E2%98%85)](https://github.com/AFK-surf/open-agent) | AFK-surf | Open-source alternative to proprietary agents like the Claude Agent SDK or ChatGPT Agents, emphasizing multi-agent collaboration. | TypeScript-based, multi-agent collaboration, computer/browser/telephone operations. |
| 🟡 **[OpenAgent](https://github.com/the-open-agent/openagent)** <br> [![Stars](https://img.shields.io/github/stars/the-open-agent/openagent?style=flat-square&label=%E2%98%85)](https://github.com/the-open-agent/openagent) | the-open-agent | Next-generation personal AI assistant with agent loops, RAG, and computer/browser control for coding tasks. | LLM-powered computer/browser control, RAG, custom agent loops. |
| 🟡 **[OpenAgentsControl](https://github.com/darrenhinde/OpenAgentsControl)** <br> [![Stars](https://img.shields.io/github/stars/darrenhinde/OpenAgentsControl?style=flat-square&label=%E2%98%85)](https://github.com/darrenhinde/OpenAgentsControl) | Darren Hinde | Plan-first developer agent framework with code review, testing, and approval-based execution. | Multi-language support (TypeScript, Python, Go), review-driven approvals. |
...
| 🟡 **[Rowboat](https://github.com/rowboatlabs/rowboat)** <br> [![Stars](https://img.shields.io/github/stars/rowboatlabs/rowboat?style=flat-square&label=%E2%98%85)](https://github.com/rowboatlabs/rowboat) | Rowboat Labs | Local-first AI coworker that builds a persistent, structured knowledge graph from files and notes. | Markdown context storage with backlinks, situational awareness for agent workflows. |
